...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "ᴍᴀɴɴᴜ ダ ᴍᴜsɪᴄ")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/AloneXBot/AloneXAnon")
...
START_IMG_URL = getenv("START_IMG_URL", "https://te.legra.ph/file/a2e4f2c097ae1503a4f93.jpg")
